...
namespace S3.Services.Registration.Controllers
{
    ...
    public class TeachersController : BaseController
    {
        ...
        [HttpGet("browse")]
        public async Task<IActionResult> GetAllAsync([FromQuery]string[]? include, Guid? schoolId, int page, int results, string orderBy, string sortOrder, bool returnSignedUpTeachers)
