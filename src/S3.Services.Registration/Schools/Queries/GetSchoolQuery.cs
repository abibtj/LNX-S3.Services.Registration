...
{
    public class GetSchoolQuery : GetQuery<School>, IQuery<SchoolDto>
    {
        [JsonConstructor]
        public GetSchoolQuery(Guid id, string[]? includeArray) : base(id, includeArray) { }
    }
}
...
//    {
//        public Guid Id { get; }
//        public Expression<Func<School, object>>[]? IncludeExpressions { get; }

//        [JsonConstructor]
//        public GetSchoolQuery(Guid id, string[]? includeArray)
//        {
//            Id = id;
...
//            {
//                var includeExpressions = new List<Expression<Func<School, object>>>();
...
//                    try
//                    {
//                        var expressionLambda = CSharpScript.EvaluateAsync<Expression<Func<School, object>>>(expressionString, options).Result;
